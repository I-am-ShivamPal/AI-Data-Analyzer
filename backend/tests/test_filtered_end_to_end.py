...
QUESTIONS = [
    ...
    "What is the total revenue in Virginia?",
]


print("=" * 70)
print("FILTERED END-TO-END AI DATA ANALYZER TEST")
print("=" * 70)
...
print("\nSTEP 6: Loading Answer Generator")
print("-" * 70)
...
for index, question in enumerate(QUESTIONS, start=1):
    ...
    # -----------------------------------------------------
    # 7A. Qwen parses question
    # -----------------------------------------------------

    print("\n[1] PARSING QUESTION")
    print("-" * 70)

    intent = question_parser.parse(question)
    ...
    # -----------------------------------------------------
    # 7B. Execute real analysis
    # -----------------------------------------------------

    print("\n[2] EXECUTING REAL DATA ANALYSIS")
    print("-" * 70)

    verified_result = analysis_executor.execute(intent)
    ...
    # -----------------------------------------------------
    # 7C. Build trusted result context
    # -----------------------------------------------------

    print("\n[3] BUILDING RESULT CONTEXT")
    print("-" * 70)

    result_context = result_context_builder.build_context(
        question=question,
    ...
    # -----------------------------------------------------
    # 7D. Generate natural-language answer
    # -----------------------------------------------------
...
print("\n")
print("=" * 70)
print("FILTERED END-TO-END TEST COMPLETED")
print("=" * 70)
